...
from routers import inventory_service_router
...
app = FastAPI(
    ...
    description="Manages catalog for restock and book availability",
    version="1.0.0"
)
...
app.include_router(inventory_service_router.router)
